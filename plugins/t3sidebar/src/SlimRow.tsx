        ...
        >
          ...
          >
            ...
            <button
              ...
              // area — lands on the column. A touch screen has no hover, so
              // there the button is always on and takes the slot outright.
              className="pointer-events-auto absolute -right-0.5 top-1/2 -translate-y-1/2 rounded p-0.5 text-muted-foreground opacity-0 hover:text-foreground focus-visible:opacity-100 group-hover/slim:opacity-100 pointer-coarse:-right-1.5 pointer-coarse:p-1.5 pointer-coarse:opacity-100"
            >
              <Icon
